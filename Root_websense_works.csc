...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>RPL Border</description>
    ...
    <motetype>
      ...
      <description>Web Sense</description>
      <source EXPORT="discard">[CONTIKI_DIR]/project/websense/websense.c</source>
      <commands EXPORT="discard">make websense.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/project/websense/websense.sky</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>40.39217174232757</x>
        <y>-21.296453046580147</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-3.5168102264242913</x>
        <y>-13.129815067572212</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>55.8923720222051</x>
        <y>5.388769693545995</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.9038463377169395 0.0 0.0 5.9038463377169395 54.891365653056106 141.4582590526857</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
